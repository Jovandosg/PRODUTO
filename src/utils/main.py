...
def read_root():
    return {"message": "Api de produtos está no ar. Acesse /docs para ver documentação Swagger da api"}
...
def obter_produto(produto_id: int, db: Session = Depends(get_db)):
    ...
    return ProdutoRead(id=produto_id, nome=produto.nome, preco=produto.preco, ativo=produto.ativo)
